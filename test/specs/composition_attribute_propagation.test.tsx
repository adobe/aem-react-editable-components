...
describe('Composition and attribute propagation ->', () => {
   ...
   */
  function testCompositionAttributePropagation(
    CompositeComponent: React.ComponentType<DummyProps>
  ) {
    ReactDOM.render(
      <CompositeComponent {...CQ_PROPS} attrToProps={'true'} />,
      rootNode
    );
    ...
    ReactDOM.render(
      <CompositeComponent {...CQ_PROPS} attrToProps={'false'} />,
      rootNode
    );
  ...
  describe('withEditorContext + withModel + withEditable ->', () => {
    it('should propagate attributes to properties', () => {
      testCompositionAttributePropagation(
        withEditorContext(withModel(withEditable(ChildComponent)))
      );
    });
  });
});
