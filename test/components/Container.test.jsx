...
describe('Container ->', () => {
    ...
    describe('childComponents ->', () => {
        ...
        it('should add the expected components', () => {
            ...
            ReactDOM.render(<Container cqItems={ITEMS} cqItemsOrder={ITEMS_ORDER}></Container>, rootNode);
        ...
        it('should add a placeholder with data attribute when in WCM edit mode', () => {
            ReactDOM.render(<Container isInEditor={true} cqPath={CONTAINER_PATH}></Container>, rootNode);
        ...
        it('should not add a placeholder when not in WCM edit mode', () => {
            ReactDOM.render(<Container></Container>, rootNode);
        ...
        it('should add a data attribute on the children when in WCM edit mode', () => {
            ...
            ReactDOM.render(<Container isInEditor={true} cqPath={CONTAINER_PATH} cqItems={ITEMS} cqItemsOrder={ITEMS_ORDER}></Container>, rootNode);
    ...
    describe('Data attributes ->', () => {
        ...
        it('should not add a the cq-data-path attribute if not in WCM edit mode', () => {
            ReactDOM.render(<Container cqPath={CONTAINER_PATH}></Container>, rootNode);
