...
describe('ResponsiveGrid ->', () => {
    ...
    describe('Column class names ->', () => {
        it('should add the expected column class names', () => {
            ...
            ReactDOM.render(<ResponsiveGrid {...STANDARD_GRID_PROPS} isInEditor={true} columnClassNames={COLUMN_CLASS_NAMES} cqPath={CONTAINER_PATH} cqItems={ITEMS} cqItemsOrder={ITEMS_ORDER} />, rootNode);
