...
describe('AllowedComponentsContainer ->', () => {
  ...
  describe('not applicable ->', () => {
    it('should NOT be applicable but have a default container placeholder', () => {
      ReactDOM.render(
        generateAllowedComponentsContainer(
  ...
  describe('applicable ->', () => {
    it('should be applicable with an empty list of allowed components', () => {
      ReactDOM.render(
        generateAllowedComponentsContainer(ALLOWED_COMPONENTS_EMPTY_DATA, true),
        rootNode
      );
      ...
      expect(allowedComponentsTitle.dataset.text).toEqual(
  ...
  describe('not in editor ->', () => {
    it('should be applicable with a list of allowed components but not in the editor', () => {
      ReactDOM.render(
        generateAllowedComponentsContainer(ALLOWED_COMPONENTS_DATA, false),
        rootNode
      );
  ...
  describe('AllowedComponentPlaceholderList ->', () => {
    it('should display two allowed components', () => {
      ...
      const allowedComponentsTitle = allowedComponentPlaceholderList.querySelector(
        ALLOWED_COMPONENT_TITLE_SELECTOR
      );
  ...
  describe('AllowedComponentPlaceholder ->', () => {
    it('should display a path, emptyLabel and the expected class names', () => {
      ...
      expect(allowedComponentPlaceholder.dataset.emptytext).toEqual(
        COMPONENT_TEXT_TITLE
      );
      expect(allowedComponentPlaceholder.dataset.cqDataPath).toEqual(
        COMPONENT_TEXT_PATH
      );
    });
  });
